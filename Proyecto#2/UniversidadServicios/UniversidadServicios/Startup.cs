...
namespace UniversidadServicios
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //"Server=.\\SQLExpress;Database=UnedProyectos;Trusted_Connection=True;"
            //services.AddDbContext<UnedProyectosContext>(opt => opt.UseSqlServer("Server=unedproyectosdatabase.database.windows.net;Database=UnedProyectos;User Id=michael;Password=Administrator1;"));
